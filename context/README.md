...
| File | What it holds |
| --- | --- |
| `HANDOFF.md` | The state of play at the end of a working session: every path touched, what changed and why it mattered, what is live outside version control, what is verified against a real run and what is not, and the brief for the next session. Written 2026-08-17; the next session's subject is subagents on a local model. |
